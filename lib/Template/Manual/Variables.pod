...
Setting C<$Template::Stash::EXPLICIT_PARAMS> to 1 will prevent template variables 
from appearing globally throughout the template hierarchy; instead, only  
explicitly passed parameters will be passed into child templates. 
